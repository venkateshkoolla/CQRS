...
namespace Ocas.Domestic.Apply.Admin.Api.Client
{
    ...
    {
        public Task<ProgramChoice> UpdateProgramChoiceEffectiveDate(Guid programChoiceId, ProgramChoiceUpdateInfo programChoiceUpdateInfo)
        {
            return Put<ProgramChoice>($"{Constants.Route.ProgramChoices}/{programChoiceId}", programChoiceUpdateInfo);
        }
