...
{
    public partial class AdminApiClient : IDisposable
    {
        private readonly HttpClient _http;
        private readonly ILogger _logger;
        private readonly JsonMediaTypeFormatter _formatter;
        private string _accessToken;
        private CultureInfo _locale = AdminApiConstants.Localization.EnglishCanada;
        ...
        public AdminApiClient(HttpClient http, ILogger logger)
        {
        ...
        public AdminApiClient WithAccessToken(string accessToken)
        {
            _accessToken = accessToken;
            return this;
        }

        public AdminApiClient WithLocale(CultureInfo locale)
        {
            if (!AdminApiConstants.Localization.SupportedLocalizations.Contains(locale))
