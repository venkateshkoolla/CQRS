...
namespace Ocas.Domestic.Apply.Admin.Api.Services.Mappers
{
    public partial class ApiMapper
    {
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.AdultTraining> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.ExpiryAction> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.HighlyCompetitive> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.MinistryApproval> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.ShsmCompletion> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.StudyArea> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.ProgramCategory> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.ProgramLanguage> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }

        public IList<LookupItem> MapLookupItem(IList<Dto.ProgramLevel> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }

        public IList<LookupItem> MapLookupItem(IList<Dto.ProgramType> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
        ...
        public IList<LookupItem> MapLookupItem(IList<Dto.TranscriptSource> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }

        public IList<LookupItem> MapLookupItem(IList<Dto.UnitOfMeasure> list)
        {
            return _mapper.Map<IList<LookupItem>>(list);
        }
