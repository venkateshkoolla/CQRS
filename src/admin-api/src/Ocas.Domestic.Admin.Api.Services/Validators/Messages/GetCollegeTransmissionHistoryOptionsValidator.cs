...
{
    public class GetCollegeTransmissionHistoryOptionsValidator : AbstractValidator<GetCollegeTransmissionHistoryOptions>
    {
        public GetCollegeTransmissionHistoryOptionsValidator()
        {
