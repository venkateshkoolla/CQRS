...
{
    public class GetProgramsReportValidator : AbstractValidator<GetProgramsReport>
    {
        public GetProgramsReportValidator(ILookupsCache lookupsCache)
        {
            ...
            RuleFor(x => x.Params)
                .SetValidator(new GetProgramOptionsValidator(lookupsCache));
        }
    }
}
