...
namespace Ocas.Domestic.Apply.Api.Services.Caches
{
    public class LookupsCache : ILookupsCache
    {
        ...
        public Task<IList<Campus>> GetCampuses()
        {
            ...
            return GetOrAddMissing(lookupKey, async () => _apiMapper.MapCampus(
        ...
        public Task<IList<CollegeApplicationCycle>> GetCollegeApplicationCycles()
        {
            ...
            return GetOrAddMissing(lookupKey, async () => _apiMapper.MapCollegeApplicationCycle(
        ...
        {
            var lookupKey = $"CourseDeliveries_{locale}";
            var crmLocale = locale.ToLocaleEnum();
        ...
        {
            var lookupKey = $"CourseStatuses_{locale}";
            var crmLocale = locale.ToLocaleEnum();
        ...
        {
            var lookupKey = $"CourseTypes_{locale}";
            var crmLocale = locale.ToLocaleEnum();
        ...
        {
            var lookupKey = $"GradeTypes_{locale}";
            var crmLocale = locale.ToLocaleEnum();
        ...
        public Task<IList<LookupItem>> GetStandardizedTestTypes(string locale)
        {
            ...
            return GetOrAddMissing(lookupKey, async () => _apiMapper.MapLookupItem(
                await _domesticContext.GetTestTypes(crmLocale, null)));
        }
        ...
        public Task<IList<University>> GetUniversities()
        {
            ...
            return GetOrAddMissing(lookupKey, async () => _apiMapper.MapUniversities(
