...
namespace Ocas.Domestic.Crm.Entities
{
	...
	public partial class BulkDeleteOperation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Ocas.Domestic.Crm.Entities.BulkDeleteOperationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Ocas.Domestic.Crm.Entities.BulkDeleteOperationState)(System.Enum.ToObject(typeof(Ocas.Domestic.Crm.Entities.BulkDeleteOperationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.BulkDeleteFailure> BulkDeleteOperation_BulkDeleteFailure
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("BulkDeleteOperation_BulkDeleteFailure");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null, value);
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.UserEntityInstanceData> userentityinstancedata_bulkdeleteoperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_bulkdeleteoperation");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null, value);
		...
		public Ocas.Domestic.Crm.Entities.AsyncOperation AsyncOperation_BulkDeleteOperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.AsyncOperation>("AsyncOperation_BulkDeleteOperation", null);
			}
		}
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_bulkdeleteoperation_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_createdonbehalfby");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_bulkdeleteoperation_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_modifiedonbehalfby");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_bulkdeleteoperationbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperationbase_createdby", null);
			}
		}
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_bulkdeleteoperationbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_bulkdeleteoperationbase_modifiedby", null);
			}
		}
