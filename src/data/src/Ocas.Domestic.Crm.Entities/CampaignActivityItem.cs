...
namespace Ocas.Domestic.Crm.Entities
{
	...
	public partial class CampaignActivityItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.UserEntityInstanceData> userentityinstancedata_campaignactivityitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_campaignactivityitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_campaignactivityitem");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_campaignactivityitem", null, value);
		...
		public Ocas.Domestic.Crm.Entities.ActivityPointer ActivityPointer_CampaignActivityItems
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ActivityPointer>("ActivityPointer_CampaignActivityItems", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActivityPointer_CampaignActivityItems");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ActivityPointer>("ActivityPointer_CampaignActivityItems", null, value);
