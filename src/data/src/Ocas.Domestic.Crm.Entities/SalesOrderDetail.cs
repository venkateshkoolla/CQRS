...
namespace Ocas.Domestic.Crm.Entities
{
	...
	public partial class SalesOrderDetail : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public static class Fields
		{
			...
			public const string Ocaslr_comments = "ocaslr_comments";
			...
			public const string OCASLR_OverrideAction = "ocaslr_overrideaction";
			public const string OCASLR_OverrideDate = "ocaslr_overridedate";
			...
			public const string OCASLR_refundchequenumber = "ocaslr_refundchequenumber";
			public const string ocaslr_refundpaymentmethodid = "ocaslr_refundpaymentmethodid";
			public const string OCASLR_RefundReasonCode = "ocaslr_refundreasoncode";
			public const string ocaslr_transcriptrequestid = "ocaslr_transcriptrequestid";
			public const string ocaslr_transferapplicationid = "ocaslr_transferapplicationid";
			...
			public const string ocaslr_application_orderitem = "ocaslr_application_orderitem";
			public const string ocaslr_ocaslr_voucher_salesorderdetail_Voucher = "ocaslr_ocaslr_voucher_salesorderdetail_Voucher";
			public const string ocaslr_paymentmethod_salesorderdetail = "ocaslr_paymentmethod_salesorderdetail";
			public const string ocaslr_programchoice_orderitem = "ocaslr_programchoice_orderitem";
			public const string ocaslr_transcriptrequest_orderitem = "ocaslr_transcriptrequest_orderitem";
			public const string ocaslr_transfer_application_salesorderdetail = "ocaslr_transfer_application_salesorderdetail";
		...
		/// <summary>
		/// Indicates which application an application order item is for.
		/// </summary>
		...
		/// <summary>
		/// A comment for a payment override state.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_comments")]
		public string Ocaslr_comments
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("ocaslr_comments");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Ocaslr_comments");
				this.SetAttributeValue("ocaslr_comments", value);
				this.OnPropertyChanged("Ocaslr_comments");
			}
		}
		
		/// <summary>
		/// Federal Tax on the Order Item
		/// </summary>
		...
		/// <summary>
		/// An override performed on item.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_overrideaction")]
		public Microsoft.Xrm.Sdk.OptionSetValue OCASLR_OverrideAction
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("ocaslr_overrideaction");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("OCASLR_OverrideAction");
				this.SetAttributeValue("ocaslr_overrideaction", value);
				this.OnPropertyChanged("OCASLR_OverrideAction");
			}
		}
		
		/// <summary>
		/// The date the item's payment was overriden (refund, transfer).
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_overridedate")]
		public System.Nullable<System.DateTime> OCASLR_OverrideDate
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<System.DateTime>>("ocaslr_overridedate");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("OCASLR_OverrideDate");
				this.SetAttributeValue("ocaslr_overridedate", value);
				this.OnPropertyChanged("OCASLR_OverrideDate");
			}
		}
		
		/// <summary>
		/// Unique identifier for Program Choice associated with Order Item.
		/// </summary>
		...
		/// <summary>
		/// The Provincial Tax on the Order Item.
		/// </summary>
		...
		/// <summary>
		/// The Refund Cheque Number
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_refundchequenumber")]
		public string OCASLR_refundchequenumber
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<string>("ocaslr_refundchequenumber");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("OCASLR_refundchequenumber");
				this.SetAttributeValue("ocaslr_refundchequenumber", value);
				this.OnPropertyChanged("OCASLR_refundchequenumber");
			}
		}
		...
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_refundpaymentmethodid")]
		public Microsoft.Xrm.Sdk.EntityReference ocaslr_refundpaymentmethodid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ocaslr_refundpaymentmethodid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_refundpaymentmethodid");
				this.SetAttributeValue("ocaslr_refundpaymentmethodid", value);
				this.OnPropertyChanged("ocaslr_refundpaymentmethodid");
			}
		}
		
		/// <summary>
		/// The reason an item was refunded.
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_refundreasoncode")]
		public Microsoft.Xrm.Sdk.OptionSetValue OCASLR_RefundReasonCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.OptionSetValue>("ocaslr_refundreasoncode");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("OCASLR_RefundReasonCode");
				this.SetAttributeValue("ocaslr_refundreasoncode", value);
				this.OnPropertyChanged("OCASLR_RefundReasonCode");
			}
		}
		
		/// <summary>
		/// Unique identifier for Transcript Request associated with Order Item.
		/// </summary>
		...
		/// <summary>
		/// Transfer Reference Application
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_transferapplicationid")]
		public Microsoft.Xrm.Sdk.EntityReference ocaslr_transferapplicationid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("ocaslr_transferapplicationid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_transferapplicationid");
				this.SetAttributeValue("ocaslr_transferapplicationid", value);
				this.OnPropertyChanged("ocaslr_transferapplicationid");
			}
		}
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.AsyncOperation> SalesOrderDetail_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.AsyncOperation>("SalesOrderDetail_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SalesOrderDetail_AsyncOperations");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.AsyncOperation>("SalesOrderDetail_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.BulkDeleteFailure> SalesOrderDetail_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.BulkDeleteFailure>("SalesOrderDetail_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SalesOrderDetail_BulkDeleteFailures");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.BulkDeleteFailure>("SalesOrderDetail_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.PrincipalObjectAttributeAccess> salesorderdetail_principalobjectattributeaccess
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.PrincipalObjectAttributeAccess>("salesorderdetail_principalobjectattributeaccess", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("salesorderdetail_principalobjectattributeaccess");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.PrincipalObjectAttributeAccess>("salesorderdetail_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.ProcessSession> SalesOrderDetail_ProcessSessions
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.ProcessSession>("SalesOrderDetail_ProcessSessions", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SalesOrderDetail_ProcessSessions");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.ProcessSession>("SalesOrderDetail_ProcessSessions", null, value);
		...
		public System.Collections.Generic.IEnumerable<Ocas.Domestic.Crm.Entities.UserEntityInstanceData> userentityinstancedata_salesorderdetail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_salesorderdetail", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_salesorderdetail");
				this.SetRelatedEntities<Ocas.Domestic.Crm.Entities.UserEntityInstanceData>("userentityinstancedata_salesorderdetail", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_salesorderdetail_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetail_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_salesorderdetail_createdonbehalfby");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetail_createdonbehalfby", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_salesorderdetail_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetail_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_salesorderdetail_modifiedonbehalfby");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetail_modifiedonbehalfby", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_salesorderdetailbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetailbase_createdby", null);
			}
		}
		...
		public Ocas.Domestic.Crm.Entities.SystemUser lk_salesorderdetailbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("lk_salesorderdetailbase_modifiedby", null);
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_application_orderitem
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_applicationid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_application_orderitem")]
		public Ocas.Domestic.Crm.Entities.ocaslr_application ocaslr_application_orderitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_application>("ocaslr_application_orderitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_application_orderitem");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_application>("ocaslr_application_orderitem", null, value);
				this.OnPropertyChanged("ocaslr_application_orderitem");
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_ocaslr_voucher_salesorderdetail_Voucher
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_voucher")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_ocaslr_voucher_salesorderdetail_Voucher")]
		public Ocas.Domestic.Crm.Entities.ocaslr_voucher ocaslr_ocaslr_voucher_salesorderdetail_Voucher
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_voucher>("ocaslr_ocaslr_voucher_salesorderdetail_Voucher", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_ocaslr_voucher_salesorderdetail_Voucher");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_voucher>("ocaslr_ocaslr_voucher_salesorderdetail_Voucher", null, value);
				this.OnPropertyChanged("ocaslr_ocaslr_voucher_salesorderdetail_Voucher");
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_paymentmethod_salesorderdetail
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_refundpaymentmethodid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_paymentmethod_salesorderdetail")]
		public Ocas.Domestic.Crm.Entities.ocaslr_paymentmethod ocaslr_paymentmethod_salesorderdetail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_paymentmethod>("ocaslr_paymentmethod_salesorderdetail", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_paymentmethod_salesorderdetail");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_paymentmethod>("ocaslr_paymentmethod_salesorderdetail", null, value);
				this.OnPropertyChanged("ocaslr_paymentmethod_salesorderdetail");
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_programchoice_orderitem
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_programchoiceid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_programchoice_orderitem")]
		public Ocas.Domestic.Crm.Entities.ocaslr_programchoice ocaslr_programchoice_orderitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_programchoice>("ocaslr_programchoice_orderitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_programchoice_orderitem");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_programchoice>("ocaslr_programchoice_orderitem", null, value);
				this.OnPropertyChanged("ocaslr_programchoice_orderitem");
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_transcriptrequest_orderitem
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_transcriptrequestid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_transcriptrequest_orderitem")]
		public Ocas.Domestic.Crm.Entities.ocaslr_transcriptrequest ocaslr_transcriptrequest_orderitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_transcriptrequest>("ocaslr_transcriptrequest_orderitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_transcriptrequest_orderitem");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_transcriptrequest>("ocaslr_transcriptrequest_orderitem", null, value);
				this.OnPropertyChanged("ocaslr_transcriptrequest_orderitem");
			}
		}
		
		/// <summary>
		/// N:1 ocaslr_transfer_application_salesorderdetail
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_transferapplicationid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("ocaslr_transfer_application_salesorderdetail")]
		public Ocas.Domestic.Crm.Entities.ocaslr_application ocaslr_transfer_application_salesorderdetail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_application>("ocaslr_transfer_application_salesorderdetail", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ocaslr_transfer_application_salesorderdetail");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.ocaslr_application>("ocaslr_transfer_application_salesorderdetail", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SalesOrder order_details
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SalesOrder>("order_details", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("order_details");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SalesOrder>("order_details", null, value);
		...
		public Ocas.Domestic.Crm.Entities.Product product_order_details
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.Product>("product_order_details", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("product_order_details");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.Product>("product_order_details", null, value);
		...
		public Ocas.Domestic.Crm.Entities.SystemUser system_user_salesorderdetail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("system_user_salesorderdetail", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("system_user_salesorderdetail");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.SystemUser>("system_user_salesorderdetail", null, value);
		...
		public Ocas.Domestic.Crm.Entities.TransactionCurrency transactioncurrency_salesorderdetail
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.TransactionCurrency>("transactioncurrency_salesorderdetail", null);
			}
		}
		...
		public Ocas.Domestic.Crm.Entities.UoM unit_of_measurement_order_details
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Ocas.Domestic.Crm.Entities.UoM>("unit_of_measurement_order_details", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("unit_of_measurement_order_details");
				this.SetRelatedEntity<Ocas.Domestic.Crm.Entities.UoM>("unit_of_measurement_order_details", null, value);
				this.OnPropertyChanged("unit_of_measurement_order_details");
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_overrideaction")]
		public virtual SalesOrderDetail_OCASLR_OverrideAction? OCASLR_OverrideActionEnum
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((SalesOrderDetail_OCASLR_OverrideAction?)(EntityOptionSetEnum.GetEnum(this, "ocaslr_overrideaction")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				OCASLR_OverrideAction = value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null;
			}
		}
		
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ocaslr_refundreasoncode")]
		public virtual SalesOrderDetail_OCASLR_RefundReasonCode? OCASLR_RefundReasonCodeEnum
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((SalesOrderDetail_OCASLR_RefundReasonCode?)(EntityOptionSetEnum.GetEnum(this, "ocaslr_refundreasoncode")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				OCASLR_RefundReasonCode = value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null;
			}
		}
